...
export class GetDetailReportResponseDto {
  ...
  @ApiProperty({
    description: 'Địa chỉ thu gom',
    example: 'công viên tam hiệp',
  })
  address: string;
  ...
  @ApiPropertyOptional({
    ...
    example: 'Có khoảng 5kg rác hữu cơ...',
  })
  description?: string;

  @ApiProperty({
    description: 'Ngày tạo đơn',
    example: '2026-01-29T10:05:27.692Z',
  })
  createdAt: Date;

  @ApiProperty({
    description: 'Cập nhật lần cuối',
    example: '2026-01-29T10:21:14.929Z',
  })
  updatedAt: Date;

  @ApiPropertyOptional({
    description: 'Lý do hủy (nếu bị hủy)',
    example: 'Tôi không có nhu cầu nữa',
  })
  cancelReason?: string;

  @ApiProperty({
    type: [WasteItemResponseDto],
    description: 'Danh sách loại rác',
  })
  ...
  @ApiProperty({
    ...
    nullable: true,
    description:
      'Thông tin doanh nghiệp (null nếu chưa có enterprise nhận đơn)',
    example: {
      id: 1,
      name: 'Công ty A',
      phone: '0901234567',
  ...
  @ApiProperty({
    ...
    nullable: true,
    description:
      'Thông tin người thu gom (null nếu chưa có collector được assign)',
    example: {
      id: 1,
