...
export class UpdateCollectorController {
  constructor(
    private readonly updateCollectorService: UpdateCollectorService,
  ) {}
  ...
  @Roles(2)
  @Permissions(PermissionCode.UPDATE_COLLECTOR)
  ...
  async updateCollector(
    ...
    return this.updateCollectorService.updateCollector(
      user.id,
      Number(id),
      dto,
    );
