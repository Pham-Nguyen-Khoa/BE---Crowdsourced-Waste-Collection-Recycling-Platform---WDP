...
export class CreateEnterpriseDto {
  ...
  @ApiProperty({ example: 1000.5, description: 'Công suất xử lý (kg)' })
  @IsNumber()
  @Min(0)
  capacityKg: number;
  ...
  @ApiProperty({
    type: [WasteTypeDto],
    example: [{ wasteType: 'ORGANIC' }, { wasteType: 'RECYCLABLE' }],
  ...
  @ApiProperty({
    example: 1,
    description: 'ID gói subscription (1: 1 tháng, 2: 6 tháng, 3: 1 năm)',
  })
  @IsNumber()
