...
export class SePayWebhookDto {
  @ApiProperty({
    example: 'FT26019830803576',
    description: 'Mã giao dịch từ ngân hàng (transaction ID)',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    example:
      '115140912829-Thanh toan PAY001-CHUYEN TIEN-OQCH0006Hkqg-MOMO115140912829MOMO',
  ...
  @ApiProperty({
    example:
      'BankAPINotify 115140912829-Thanh toan PAY001-CHUYEN TIEN-OQCH0006Hkqg-MOMO115140912829MOMO',
  ...
  @ApiProperty({
    example: 10000,
    description: 'Số tiền chuyển (duplicate của amount)',
  })
  @IsNumber()
  @IsOptional()
  @Transform(({ value }: TransformFnParams) => {
