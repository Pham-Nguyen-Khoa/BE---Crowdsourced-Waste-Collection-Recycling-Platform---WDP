...
@ApiTags(`${resourcesV1.GET_DETAIL_REPORT_WAITING.parent}`)
@Controller(routesV1.apiversion)
export class GetDetailReportWaitingController {
  constructor(
    private readonly getDetailService: GetDetailReportWaitingService,
  ) {}
  ...
  async getDetail(@GetUser() user, @Param('id') reportId: number) {
